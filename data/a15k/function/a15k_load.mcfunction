...
scoreboard objectives add a15k_multx10 dummy
scoreboard objectives add a15k_multi dummy
scoreboard objectives add a15k_multd dummy
## Constants
...
scoreboard players set .c14 a15k_math 14
scoreboard players set .c15 a15k_math 15
scoreboard players set .c1500 a15k_math 1500
...
tellraw @a [{"color":"#00FFEE","text":"["},{"color":"#00FFC0","text":"✦"},{"color":"#00FF92","text":"✦"},{"color":"#00FF64","text":"✦"},{"color":"#00FF08","text":"]"},{"bold":true,"color":"green","text":" 🧪"},{"color":"white","text":"⇄ "},{"color":"#05FF0D","text":"A"},{"color":"#05F94A","text":"1"},{"color":"#05F386","text":"5"},{"color":"#05E6FF","text":"K "},{"color":"yellow","text":"(Re)-Initiated "},{"bold":true,"color":"green","score":{"name":".reload","objective":"a15k_reload"}},{"color":"yellow","text":" Reloads "},{"color":"#00FFEE","text":"["},{"color":"#00FFC0","text":"✦"},{"color":"#00FF92","text":"✦"},{"color":"#00FF64","text":"✦"},{"color":"#00FF08","text":"]"}]