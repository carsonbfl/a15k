...
## ---- roll: n = 2*x^2 + 15 ----
execute store result score @s a15k_probability run data get entity @s equipment.mainhand.components."minecraft:enchantments"."minecraft:wind_burst"
...
## on success
execute if score @s a15k_probability matches 0 run function a15k:a15k-mcb/78